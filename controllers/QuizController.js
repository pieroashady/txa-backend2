...
class QuizController {
  ...
  static async addQuiz(req, res) {
    ...
    const createdBy = Admin.createWithoutData(req.body.idAdmin);
  ...
  static async deleteQuiz(req, res) {
    ...
    results.save().then(() => res.json({ message: 'Success delete quiz' })).catch((error) => res.json(error));
  }
}
